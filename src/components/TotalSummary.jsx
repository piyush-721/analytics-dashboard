...
const TotalSummary = () => {
  const { summary: data, loading, error } = useDashboardData();
        ...
        <div className="p-6 hidden lg:block">
          ...
          <div className="grid grid-cols-7 gap-4">
            {[...Array(7)].map((_, index) => (
              <div 
                key={`skeleton-${index}`} 
                className="text-center animate-pulse bg-white w-[159px] h-[98px] rounded-[6.8px] shadow-[0_4px_13.3px_0_rgba(0,0,0,0.03)] flex flex-col justify-center items-center p-[12px]"
              >
      ...
      <div className="bg-white p-6 hidden lg:block">
        ...
        <div className="grid grid-cols-7 gap-4">
          {data?.map((metric) => (  
            <div 
              key={metric.id} 
              className="text-center bg-white w-[159px] h-[98px] rounded-[6.8px] shadow-[0_4px_13.3px_0_rgba(0,0,0,0.03)] flex flex-col justify-center items-center p-[12px]"
            >
