...
const Header = () => {
  return (
    <>
      {/* Desktop: EXACT original header */}
      <header 
        className="bg-white px-4 py-6 ml-10 hidden lg:block" 
        style={{ width: '1314px' }}
      >
      ...
      {/* Mobile: Compact responsive header */}
      <header className="bg-white px-4 py-4 border-b border-gray-200 lg:hidden">
        <div className="flex flex-col space-y-3">
          ...
          <div className="flex items-center space-x-3 text-sm">
            ...
            <span className="text-gray-600">Jul 5 - Jul 11, 2025</span>
          </div>
        </div>
      </header>
    </>
